...
def build_grading_prompt(
    ...
    return (
        ...
        f"{reference_section}\n"
        "Evidence must be visibly demonstrated. Presence of concepts or terminology is not "
        "by itself evidence of integration or application. Do not infer relationships from "
        "proximity, uninterpreted arrows, a diagnosis alone, symptoms beside a diagnosis, or "
        "a named mechanism. Distinguish missing detail from missing reasoning: substantial but "
        "incomplete evidence generally matches score 3, while superficial, generic, isolated, "
        "or weakly connected content matches score 2. A strong map may meet expectations despite "
        "secondary weaknesses; a weak list-based map without meaningful relationships should not.\n"
